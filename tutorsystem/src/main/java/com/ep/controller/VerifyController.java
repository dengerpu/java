...
import com.ep.utils.VerifyUtil;
...
public class VerifyController {
    ...
    @ResponseBody
    public ResultInfo checkCode(String code, HttpServletRequest request) {
        HttpSession session = request.getSession();
        String id = session.getId();
        ...
        long num = redisTemplate.opsForValue().decrement(verifyCodeKey);//这里的num值为-1所以不再判断次数
