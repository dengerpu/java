public class example62 {
    public static void main(String[] args) {
        System.out.println("计算绝对值得结果"+Math.abs(-1));
        ...
        System.out.println("求小数进行四舍五入的结果"+Math.round(-8.6));
        System.out.println("求两个数的最大值"+Math.max(5.1,5.5));
        System.out.println("请两个数的最=较小值"+Math.min(5.1,5.5));
